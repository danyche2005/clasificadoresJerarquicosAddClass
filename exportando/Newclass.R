...
techniqueClassifOps<-c("RPART","SVM-EX","knn","nnet","RF-EX","C50","NB-EX")#"RPART","NB-EX","SVM-EX","knn","nnet","RF-EX","C50"
nombreDatasetOps<-c("pendigits")#"flare","letters","forest","sports",dermatology
balanceOpt<-TRUE
...
for (i in (1:n)){
  ...
  funTrainingLNP3(graph = classHierarVal[i][[1]], dataTraining = Val, tecnicaEntrenamiento = techniqueClassif, probabilitiesOp = probabilityOptions)
